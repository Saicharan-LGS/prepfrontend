...
function WalletAdd(){
    ...
    const handleProceed=()=>{
        ...
        navigate(`/payment?encryptedText=${encodedText}`);
    }
    ...
    return(
        <div className="wallet-add-main-container">
            <div  className="wallet-add-sub-container">
                ...
                <div className="wallet-add-field-container">
                    <select className="wallet-add-field-container" value={selectedOption}  onChange={handleOptionChange}>
                        <option className="wallet-add-input" value="Credit Card" >Credit Card</option>
                    </select>
                </div>
                <button className="service-add-button" onClick={handleProceed}>Proceed</button>
            </div>
        </div>
    )
}
